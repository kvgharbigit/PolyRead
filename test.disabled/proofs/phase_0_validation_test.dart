...
// import 'package:polyread/core/proofs/sqlite_performance_proof.dart'; // Disabled - legacy format

void main() {
  // Initialize SQLite for testing  
  setUpAll(() {
    // initializeSqliteForTesting(); // Disabled - legacy proof
  });
  ...
  group('Phase 0: Architecture Validation Tests', () {
    ...
    // SQLite Performance tests disabled - legacy dictionary format
    /*
